...
export default function AdminPage() {
  ...
  function buildChroniclePrompt(
    ...
    const newsInfo = newsArticles.length === 0
      ...
      : newsArticles.map((a, i) => `  ${i + 1}. ${a.title}${a.description ? ` — ${a.description}` : ""} (${a.source})`).join("\n");
